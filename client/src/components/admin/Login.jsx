...
const Login = () => {
  ...
  return (
    <div className='flex items-center justify-center h-screen'>
      <div className='w-full max-w-sm p-6 max-md:m-6 border boarder-primary/30 shadow-xl shadow-primary/15 rounded-lg'>
        <div className='flex flex-col items-center justify-center'>
          ...
          <form onSubmit={handleSubmmit} className='mt-6 w-full sm:max-w-md text-gray-600'>
