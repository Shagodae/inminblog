...
const Newsletter = () => {
  return (
    <div className='flex flex-col items-center justify-center texet-center space-y-2 my-32'>
      <h1 className='md:text-4xl text-2xl font-semibold'>Never Miss a Blog!</h1>
      <p className='md:text-lg text-gray-500/70 pb-8'>Stay in the loop with our latest blogs, tech breakthroughs, and members-only news—subscribe now!</p>
